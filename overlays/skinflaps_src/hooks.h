...
public:
	...
	// reconcile registry and graphics to a saved copy of this object; physics
	// constraints are left for the caller's lattice rebuild, which re-adds
	// them through updateHookPhysics().
	void restoreState(const hooks& saved);
