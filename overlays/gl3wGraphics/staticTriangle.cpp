...
#ifdef __APPLE__
// Using gl3w loader; avoid redefining gl*VertexArray to APPLE variants.
#endif
...
//	const materialTriangles::matTriangle* trArr = _mt->getTriangleArray(n);
	...
	_snNow->elementArraySize = (GLsizei)tris.size();  // element count, not bytes: the draw call reads exactly the index set
