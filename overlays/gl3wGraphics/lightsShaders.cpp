...
#  define LS_GLSL_130 "#version 150\n"
#  define LS_GLSL_150 "#version 150\n"
#else
#  define LS_GLSL_130 "#version 130\n"
#  define LS_GLSL_150 "#version 150\n"
#endif

static const char *normalTangentVertexShader = LS_GLSL_130
"in vec4 vVertex;\n"
"in vec2 vTexture;\n"
"out vec3 vPosition;\n"
"out vec2 vTexCoords;\n"
...
static const char *normalTangentGeometryShader = LS_GLSL_150 // geometry shaders require at least version 1.5
"layout(triangles) in;\n"
"in VertexData{\n"
"	vec3 vPosition;\n"
"	vec2 vTexCoords;\n"
...
static const char *GTVertexShaderColoredLine = LS_GLSL_130
	"in vec4 vVertex;\n"
...
static const char *GTFragmentShaderColoredLine = LS_GLSL_130
	"out vec4 vFragColor;\n"
...
static const char *GTVertexShaderColoredPhong = LS_GLSL_130
	"in vec4 vVertex;\n"
	"in vec3 vNormal;\n"
	"uniform mat4   mvpMatrix;\n"
...
static const char *GTFragmentShaderColoredPhong = LS_GLSL_130
...
static const char *GTVertexShaderDefault = LS_GLSL_130
	// Incoming per vertex
	"in vec4 vVertex;\n"
	"in vec3 vNormal;\n"
	"in vec2 vTexture;\n"
